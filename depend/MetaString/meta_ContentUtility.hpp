...
namespace meta
{
    ...
    template<template<typename type_t, type_t... str> class Content_t, typename Type_t, Type_t v, Type_t... val>
    ...
    template<template<typename type_t, type_t... str> class Content_t, typename Type_t, Type_t d, Type_t... data>
    ...
    template<typename Content_t>
    struct get_last_value_meta
    {
        static constexpr typename get_content_info<Content_t>::content_type value = get_first_value_meta<Extract_begin<Content_t, get_content_info<Content_t>::DataSize-1> >::value;
    };
    ...
    template<typename Content_t>
    constexpr typename get_content_info<Content_t>::content_type get_last_value = get_last_value_meta<Content_t>::value;
#endif

    static_assert((get_first_value_meta<Pop_front_content<Add_end_value<Content<char, 'a'>, 'b'> > >::value == 'b'), "binaire api test fail");
    ...
    static_assert((get_i_value_meta<Content<char, 'a', 'k', '6', '5', '6'>, 0>::value == 'a'), "binaire api test fail");
    static_assert((get_i_value_meta<Content<char, 'a', 'k', '6', '5', '6'>, 3>::value == '5'), "binaire api test fail");
    static_assert(((get_last_value_meta<Content<char, 'a', 'k', '6', '5', '6'> >::value) == '6'), "binaire api test fail");
