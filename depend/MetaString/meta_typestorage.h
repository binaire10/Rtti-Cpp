...
static_assert((ContainType_meta<char, std::tuple<int, char, int , char> >::value)==true, "size fail");
static_assert((ContainType_meta<double, std::tuple<int, char, int , char> >::value)==false, "size fail");
